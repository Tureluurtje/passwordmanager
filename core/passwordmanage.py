...
def addpass(user, masterpass, namepass, usernamepass, password, notes):
    ...
    try:
        ...
        query = """
INSERT INTO passwords(user_id, app_name, app_username, encrypted_password, created_at, updated_at, notes)
VALUES(%s, %s, %s, %s, %s, %s, %s)
"""
        values = (user[0], namepass, usernamepass, encrypted_password, datetime.datetime.now(), datetime.datetime.now(), notes)
